...
My first contact with computers was in the 80's when I learned to program using BASIC in the 8 bit machines: a [Sinclair ZX81](https://en.wikipedia.org/wiki/Sinclair_ZX81 "Sinclair ZX81") clone ([CP-200 - Wikipedia](https://en.wikipedia.org/wiki/CP-200)) and an [Apple II](https://en.wikipedia.org/wiki/Apple_IIe) clone ([TK-3000 IIe - Wikipedia](https://en.wikipedia.org/wiki/TK-3000_IIe)).

If you never saw an ancient BASIC program, it looks like this:
...
To learn more about [BASIC]([BASIC - Wikipedia](https://en.wikipedia.org/wiki/BASIC) language check this link.
...
Converting these programs can be fun, but sometimes can be very hard to untangle the nested "GOTO" jumps. Here is where AI comes into play. I am using AI tools for my job and I think there are some interesting use cases for it and this is one of them.
...
![Game in HTML5](/assets/images02-htmlv1.png)
...
![Flowchart 1](/assets/imagesdiagram_1.png)
